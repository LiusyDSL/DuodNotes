...
public class CodeGenerator {
     ...
     * </p>
     *
     *  模块名 ： 就是在根路径的包下再多加一个包路径让生成的代码都处于模块名的包路径下
     */
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.10.100:3306/geotest?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        //相当于包的根路径
        pc.setParent("cn.com.geostar.test");
        //自定义设置controller的路径
